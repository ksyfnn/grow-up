        ...
        <nav class="navbar navbar-expand-lg bg-dark">
            <div class="container">
                <a class="navbar-brand text-light" href="/home">
                    <img src="{{asset ("image/logo/rp.png") }}" alt="logo" width="40" heigth="40" class="me-3">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto" style="text-transform: capitalize;">
                        ...
                        <li class="nav-item">
                            <a href="/jabatan/index" class="nav-link active text-light fs-5" aria-current="page">jabatan</a>
                        </li>
                        <li class="nav-item">
